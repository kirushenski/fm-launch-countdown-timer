const config = {
  ...
  shortTitle: 'FM Launch countdown timer',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Launch countdown timer" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-launch-countdown-timer.netlify.app',
